        ...
        <div class="row">                                  
          <div class="col-auto">
            ...
            <p>${this.firstName} ${this.lastName}</p>
              <p class="name-email-phone"><span class="name-bold">E-Mail:</span> ${this.email}</p>
              <p class="name-email-phone"><span class="name-bold">Tel:</span>  ${this.phone.toString().replace(/\B(?=(\d{3})+(\d{4})+(?!\d))/g, " ")}</p>
              <p class="name-region"><span class="name-bold">Region:</span> ${this.region_names}.</p>
            </div>              
            <!--Form-->
